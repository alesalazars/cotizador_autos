...
class Seguro{
  ...
  cotizarSeguro(){
    ...
    */
    ...
    // leer el año, diferencia entre el año actual menos el ingresado
...
class Interfaz{
 // mensaje de error que se imprime en el HTML
  ...
  // mensaje que imprime el resultado de la cotizacion
